...
export default async function Page() {
	...
	return (
		<div className='flex h-screen w-full flex-col items-center justify-center gap-10 p-5'>
			...
			<div className='z-10 flex h-[80vw] w-[80vw] flex-col items-center justify-center gap-5 rounded-full bg-gradient-to-br from-[#5BDCF9] via-[#2E73FC] to-[#000AFF] p-2 text-center transition-all duration-300 sm:h-[60vw] sm:w-[60vw] sm:p-10 md:h-[50vw] md:w-[50vw] lg:p-12 xl:h-[35vw] xl:w-[35vw] 2xl:h-[20vw] 2xl:w-[20vw]'>
